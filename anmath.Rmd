...
Moving on to *populism* variables, let's do a faceted plot to get a feel of how the odds of swing voter vary with each populism variable
...
ggplot(WTHH.pop.long, aes(x=response, y=swing_voter)) + geom_point(alpha=0.4) +
  ...
  facet_wrap(~populism) +
  labs(caption="1:Strongly support 2:Somewhat support 3:Neutral 4:Somewhat oppose 5:Strongly oppose") +
  ggtitle("Logistic regression fits for odds of Swing Voters by Populism") +
  xlab("Response") + ylab("Probability of Swing voter") +
  theme_bw()
```
...
WTHH.issue.logit.df$.pred <- 1 * (WTHH.issue.logit.df$.fitted > 0.5)
